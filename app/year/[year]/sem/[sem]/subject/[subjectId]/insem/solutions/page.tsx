...
export default function InsemSolutions({ params }: { params: { subjectId: string } }) {
  ...
  useEffect(() => {
    ;(async () => {
      const res = await fetch('/api/resources/list', {
        ...
        body: JSON.stringify({ subjectId, type: 'SOLUTION', examType: 'INSEM', hasFile: true }),
      })
  ...
  return (
    <main>
      <h2 className="text-xl font-semibold mb-4">Insem PYQ Solutions</h2>
